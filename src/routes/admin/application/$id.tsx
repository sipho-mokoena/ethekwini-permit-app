...
import { useApplication, useUploadedDocuments, useUpdateApplicationStatus } from '../../../hooks/useApplications'
import { ArrowLeft, Download, Clock, CheckCircle, XCircle, Eye } from 'lucide-react'
          ...
          <Card>
            ...
            <CardContent className="space-y-4">
              <div className="grid md:grid-cols-2 gap-4">
                <div>
                  <span className="font-medium text-sm text-muted-foreground">Owner Name</span>
                ...
                <div>
                  <span className="font-medium text-sm text-muted-foreground">Trade Name</span>
              ...
              {(formData.businessType || formData.employeeCount || formData.operatingHours) && (
                <div className="border-t pt-4">
                  ...
                  <div className="grid md:grid-cols-2 gap-4">
                    ...
                    {formData.employeeCount && (
                      <div>
                        <span className="font-medium text-sm text-muted-foreground">Number of Employees</span>
                        <p>{formData.employeeCount}</p>
                      </div>
                    )}
                    {formData.operatingHours && (
                      <div className="md:col-span-2">
                        <span className="font-medium text-sm text-muted-foreground">Operating Hours</span>
              ...
              {formData.additionalInfo && (
                <div className="border-t pt-4">
                  <span className="font-medium text-sm text-muted-foreground">Additional Information</span>
              ...
              <div className="space-y-4">
                ...
                {application.status !== 'submitted' && (
                  <div className="flex items-center space-x-3">
                    ...
                    <div>
                      <p className="font-medium capitalize">Status Updated: {application.status}</p>
                      <p className="text-sm text-muted-foreground">
