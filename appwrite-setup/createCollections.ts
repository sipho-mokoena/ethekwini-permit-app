  ...
  try {
    ...
    try {
      ...
      const applicationAttributes = [
        ...
        { key: 'status', type: 'enum', elements: ['submitted', 'reviewing', 'approved', 'rejected'], required: true, default: 'submitted' }
      ]
    ...
    console.log('3. Update your .env file with the correct endpoint and project ID')
